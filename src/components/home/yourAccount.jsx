...
import styles from './styles/yourAccountStyles.module.css';
    ...
    render() { 
        ...
        return ( 
            <div>
                ...
                <div align='center'>
                    <h1>Your Details</h1>
                    <input placeholder='Email' className={styles.inputBox}></input><br></br>              
                    <input placeholder='Password' className={styles.inputBox}></input><br></br> 
                    <input type="date" className={styles.inputBox}></input><br></br> 
                    <input placeholder="Address" className={styles.inputBox}></input><br></br> 
                    <select name="currencies" className={styles.inputBox} style={{paddingTop:'5px',paddingBottom:'5px'}}>
